...
from .views import SignupView, LoginView, test_email, logout_api_view, LogoutView, UserInfoUpdateView, UserDeleteView, password_reset_request, password_reset_confirm
from . import views
